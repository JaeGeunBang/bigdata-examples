...
public class GenerateProductLog {
	...
	static final Option NO_OF_LOGS_OPT = new Option("l", "numberOfLogs", true, "number of logs");
	...
	public static Options getOptions() {
		...
		options.addOption(NO_OF_LOGS_OPT);
	...
	public static void main(String[] args) throws IOException {
		...
		String numberOfLogsOpt = cmdLine.getOptionValue(NO_OF_LOGS_OPT.getOpt());
		...
		int numberOfLogs = Integer.parseInt(numberOfLogsOpt);
		if (numberOfLogs > 100000) {
			System.err.println("Maximum number of logs allowed is 100000");
			System.exit(0);
		}

		System.out.println("============================ Logs Started =================================");

		KalyanUtils.generateProductLog(path, numberOfUsers, numberOfLogs, delimiterOpt, 100);
